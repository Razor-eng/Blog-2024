...
export default function SignUp() {
  ...
  return (
    <div className='md:min-h-screen mt-20'>
      <div className='px-5 pb-10 pt-4 max-w-md mx-auto shadow-md border dark:border-zinc-500 rounded-lg'>
        {/* left */}
        ...
        <div className='flex-1 px-2 lg:px-5'>
          <div className="flex flex-col gap-3 my-4 text-center">
            ...
            <p className='text-zinc-500 font-semibold text-sm'>Enter the required fields to continue with your signup.</p>
          ...
          <div className='flex gap-2 text-sm mt-5 justify-center font-medium text-zinc-500'>
            ...
            <Link to='/sign-in' className='text-blue-500 hover:text-blue-600 hover:underline underline-offset-2 transition-all ease-in duration-150'>
              Sign In
            </Link>
          </div>
          {/* {errorMessage && (
